...
public class UserServiceConfig {
    @Bean
    public UserService userService(UserRepository userRepository, StoryRepository storyRepository, PromptService promptService){ return new UserServiceImpl(userRepository, storyRepository, promptService); }
}
